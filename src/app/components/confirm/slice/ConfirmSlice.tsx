...
export const confirmSlice = createSlice({
  ...
  reducers: {
    ...
    chooseConfirm: (
      state,
      actions: PayloadAction<stateConfirm["response"]>
    ) => {
...
export const { openConfirm, closeConfirm, chooseConfirm, displayConfirm } =
...
export const acceptBtnTextConfirm = (state: RootState) =>
  state.confirm.btn_accept;
export const cancelBtnTextConfirm = (state: RootState) =>
  state.confirm.btn_cancel;
