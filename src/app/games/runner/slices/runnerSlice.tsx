...
export interface positionType { left : number; right : number; top : number; bottom : number};
    ...
    reducers: {
        ...
        levelUp(state){
            ...
            if(state.speedAppearEnnemy > optionsRunner.maxSpeedEnnemy){
                state.speedAppearEnnemy = state.speedAppearEnnemy - optionsRunner.augmentationSpeedEnnemyByLevel
            }
        },
        takeBonus(state){
...
export const selectColisionPlayer = (state:RootState) => state.runner.colisionPlayer;
