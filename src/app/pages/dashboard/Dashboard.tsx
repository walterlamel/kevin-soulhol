  ...
  return (
    <>
      ...
      <div className="dashboard-page otherpage">
        ...
        <p>
          Ici vous trouverez les informations relatives à votre compte
          personnel.
        </p>
        ...
        <div className="container-infos">
          <div className="info">
            ...
            <div className="contain-label">
              ...
              <ValidButton
                valueBase={valueName}
                valueLast={valueNameLast}
                namevalue="name"
                functionClick={handleInput}
                loading={loader.includes("name")}
                error={errorsInps.includes("name")}
              />
            </div>
          </div>
          <div className="info">
            ...
            <div className="contain-label">
              ...
              />
              <ValidButton
                valueBase={valuePrenom}
                valueLast={valuePrenomLast}
                namevalue="prenom"
                functionClick={handleInput}
                loading={loader.includes("prenom")}
                error={errorsInps.includes("prenom")}
              />
            </div>
          </div>
          <div className="info">
            ...
            <div className="contain-label">
              ...
              />
              <ValidButton
                valueBase={valueEmail}
                valueLast={valueEmailLast}
                namevalue="email"
                functionClick={handleInput}
                loading={loader.includes("email")}
                error={errorsInps.includes("email")}
              />
            </div>
          </div>
          <div className="info">
            ...
            <div className="contain-label">
              ...
              <ValidButton
                valueBase={valuePass}
                valueLast={valuePassLast}
                namevalue="password"
                functionClick={handleInput}
                loading={loader.includes("password")}
                error={errorsInps.includes("password")}
              />
            </div>
          </div>
        </div>
