...
const SectionProjet = () => {
  ...
  const [selectedKeyToModif, setSelectedKeyToModif] = useState<
    keyof ProjectType | null
  >(null);
  ...
  function openModal(
    item: ProjectType,
    paramToModif: keyof ProjectType | null
  ) {
    if (item) {
      setOpenedModal(true);
      ...
      {isAdmin && (
        <section>
          ...
          <ModalText
            ...
            selectedKeyToModif={selectedKeyToModif}
            reloading={reloading}
          />
        </section>
      )}
...
export const LigneProjet = ({
  ...
  return (
    <tr>
      <td onClick={(e) => navigate("/add", { state: { id: item.id } })}>
        {item.title}
      </td>
      <td onClick={(e) => navigate("/add", { state: { id: item.id } })}>
        {item.type}
      ...
      {isAdmin && (
        <>
          ...
          <td className="littleRow" onClick={(e) => deleteItem()}>
...
export const ModalText = ({
  ...
  selectedKeyToModif: keyof ProjectType | null;
  reloading: Function;
}) => {
